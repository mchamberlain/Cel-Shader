...
bl_info = {
    "name": "Extended Raw mesh format (.raw)",
    "author": "Anthony D,Agostino (Scorpius), Aurel Wildfellner",
    "version": (0, 2),
    "blender": (2, 5, 7),
    "location": "File > Import-Export > Raw Faces (.raw) ",
    "description": "Export Raw Faces, Normals, Colours and Texture coordinates",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
...
class RawExporter(bpy.types.Operator):
    ...
    bl_idname = "export_mesh_extended.raw"
    bl_label = "Export Extended RAW"
...
def menu_import(self, context):
    self.layout.operator(RawImporter.bl_idname, text="Extended Raw Faces (.raw)")


def menu_export(self, context):
    self.layout.operator(RawExporter.bl_idname, text="Extended Raw Faces (.raw)")
